...
Texture* Texture::create(Format format, unsigned int width, unsigned int height, const unsigned char* data, bool generateMipmaps, Texture::Type type)
{
    ...
    {
    	minFilter = NEAREST;
    	GPRHI_ASSERT( GPRHI_TexParameteri(target, GP_RHI_TEXTURE_PARAM_MAG_FILTER, GP_RHI_TEXTURE_FILTER_NEAREST) );
    	GPRHI_ASSERT( GPRHI_TexParameteri(target, GP_RHI_TEXTURE_PARAM_MIN_FILTER, GP_RHI_TEXTURE_FILTER_NEAREST) );
    	GPRHI_ASSERT( GPRHI_TexParameteri(target, GP_RHI_TEXTURE_PARAM_WRAP_S, GP_RHI_TEXTURE_WRAP_CLAMP_TO_EDGE) );
    	GPRHI_ASSERT( GPRHI_TexParameteri(target, GP_RHI_TEXTURE_PARAM_WRAP_T, GP_RHI_TEXTURE_WRAP_CLAMP_TO_EDGE) );
