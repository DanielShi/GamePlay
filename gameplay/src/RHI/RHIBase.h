...
enum GP_RHI_BLEND_FUNC {
	...
	GP_RHI_BLEND_DST_COLOR								= GL_DST_COLOR,
	...
	GP_RHI_BLEND_ONE_MINUS_DST_COLOR					= GL_ONE_MINUS_DST_COLOR,
	GP_RHI_BLEND_CONSTANT_ALPHA							= GL_CONSTANT_ALPHA,
	GP_RHI_BLEND_SRC_ALPHA_SATURATE						= GL_SRC_ALPHA_SATURATE,
	GP_RHI_BLEND_ONE_MINUS_CONSTANT_ALPHA				= GL_ONE_MINUS_CONSTANT_ALPHA,
};

enum GP_RHI_CULL_FACE {
	GP_RHI_CULL_FACE_BACK								= GL_BACK,
	GP_RHI_CULL_FACE_FRONT								= GL_FRONT,
	GP_RHI_CULL_FACE_FRONT_AND_BACK						= GL_FRONT_AND_BACK,
};
...
enum GP_RHI_COMPARE_FUNC {
	GP_RHI_COMPARE_FUNC_NEVER							= GL_NEVER,
	GP_RHI_COMPARE_FUNC_LESS 							= GL_LESS,
	GP_RHI_COMPARE_FUNC_EQUAL 							= GL_EQUAL,
	GP_RHI_COMPARE_FUNC_LEQUAL 							= GL_LEQUAL,                        
	GP_RHI_COMPARE_FUNC_GREATER 						= GL_GREATER,                       
	GP_RHI_COMPARE_FUNC_NOTEQUAL 						= GL_NOTEQUAL,                      
	GP_RHI_COMPARE_FUNC_GEQUAL 							= GL_GEQUAL,                        
	GP_RHI_COMPARE_FUNC_ALWAYS 							= GL_ALWAYS,                        
};

enum GP_RHI_STENCILOP {
	GP_RHI_STENCILOP_KEEP								= GL_KEEP,
	GP_RHI_STENCILOP_ZERO								= GL_ZERO,
	GP_RHI_STENCILOP_REPLACE							= GL_REPLACE,
	GP_RHI_STENCILOP_INCR								= GL_INCR,
	GP_RHI_STENCILOP_DECR								= GL_DECR,
	GP_RHI_STENCILOP_INVERT								= GL_INVERT,
	GP_RHI_STENCILOP_INCR_WRAP							= GL_INCR_WRAP,
	GP_RHI_STENCILOP_DECR_WRAP							= GL_DECR_WRAP,
};

enum GP_RHI_GET {
	GP_RHI_GET_MAX_VERTEX_ATTRIBS						= GL_MAX_VERTEX_ATTRIBS,
	GP_RHI_GET_FRAMEBUFFER_BINDING						= GL_FRAMEBUFFER_BINDING,
	GP_RHI_MAX_COLOR_ATTACHMENTS						= GL_MAX_COLOR_ATTACHMENTS,
};
#else

enum GP_RHI_CLEAR_FLAG {
	GP_RHI_CLEAR_COLOR_BUFFER						,	
	GP_RHI_CLEAR_DEPTH_BUFFER						,	
	GP_RHI_CLEAR_STENCIL_BUFFER						,	
};

enum GP_RHI_BUFFER_TYPE {
	GP_RHI_BUFFER_ARRAY								,	
	GP_RHI_BUFFER_INDEX								,	
	GP_RHI_BUFFER_FRAME_BUFFER						,	
	GP_RHI_BUFFER_RENDER_BUFFER						,	
};
enum GP_RHI_BUFFER_ATTACHMENT {
	GP_RHI_BUFFER_ATTACHMENT_COLOR_0				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_1 				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_2 				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_3 				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_4 				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_5 				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_6 				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_7 				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_8 				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_9 				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_10				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_11 				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_12				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_13				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_14				,	
	GP_RHI_BUFFER_ATTACHMENT_COLOR_15				,	
	GP_RHI_BUFFER_ATTACHMENT_DEPTH					,	
	GP_RHI_BUFFER_ATTACHMENT_STENCIL 				,	
};

enum GP_RHI_FRAMEBUFFER_STATUS {
	GP_RHI_FRAMEBUFFER_COMPLETE						,	
};
enum GP_RHI_BUFFER_ALLOC {
	GP_RHI_BUFFER_DANAMIC							,	
	GP_RHI_BUFFER_STATIC							,	
};
...
enum GP_RHI_FORMAT {
	...
	GP_RHI_FORMAT_S8								,	
	//the buffer data format
	GP_RHI_FORMAT_UNSIGNED_BYTE						,		
	GP_RHI_FORMAT_UNSIGNED_SHORT					,		
	GP_RHI_FORMAT_UNSIGNED_SHORT_5_6_5				,		
	GP_RHI_FORMAT_UNSIGNED_SHORT_4_4_4_4			,		
	GP_RHI_FORMAT_UNSIGNED_SHORT_5_5_5_1			,		
	GP_RHI_FORMAT_FLOAT								,		
	GP_RHI_FORMAT_UNSIGNED_INT						,		
};

enum GP_RHI_TOPOLOGY {
	GP_RHI_TOPOLOGY_TRIANGLES						,			
	GP_RHI_TOPOLOGY_TRIANGLE_STRIP					,			
	GP_RHI_TOPOLOGY_LINES							,			
	GP_RHI_TOPOLOGY_LINE_STRIP						,			
	GP_RHI_TOPOLOGY_LINE_LOOP						,			
	GP_RHI_TOPOLOGY_POINTS							,			
};

enum GP_RHI_TEXTURE_PARAM_NAME {
	GP_RHI_TEXTURE_PARAM_GENERATE_MIPMAP			,			
	GP_RHI_TEXTURE_PARAM_MAG_FILTER					,			
	GP_RHI_TEXTURE_PARAM_MIN_FILTER					,			
	GP_RHI_TEXTURE_PARAM_WRAP_S						,			
	GP_RHI_TEXTURE_PARAM_WRAP_T						,			
	GP_RHI_TEXTURE_PARAM_WRAP_R						,			
	GP_RHI_TEXTURE_PARAM_COMPARE_MODE				,			
};

enum GP_RHI_TEXTURE_WRAP {
	GP_RHI_TEXTURE_WRAP_REPEAT						,	
	GP_RHI_TEXTURE_WRAP_CLAMP_TO_EDGE				,	
};

enum GP_RHI_TEXTURE_FILTER {
	GP_RHI_TEXTURE_FILTER_NEAREST					,	
	GP_RHI_TEXTURE_FILTER_LINEAR					,	
	GP_RHI_TEXTURE_FILTER_NEAREST_MIPMAP_NEAREST	,	
	GP_RHI_TEXTURE_FILTER_LINEAR_MIPMAP_NEAREST 	,	    
	GP_RHI_TEXTURE_FILTER_NEAREST_MIPMAP_LINEAR 	,	    
	GP_RHI_TEXTURE_FILTER_LINEAR_MIPMAP_LINEAR 		,	    
};

enum GP_RHI_TEXTURE_TARGET {
	GP_RHI_TEXTURE_TARGET_TEXTURE_2D				,	
	GP_RHI_TEXTURE_TARGET_TEXTURE_CUPE_MAP			,	
	GP_RHI_TEXTURE_TARGET_CUBE_MAP_POSITIVE_X		,	
	GP_RHI_TEXTURE_TARGET_CUBE_MAP_NEGETIVE_X 		,	
	GP_RHI_TEXTURE_TARGET_CUBE_MAP_POSITIVE_Y 		,	
	GP_RHI_TEXTURE_TARGET_CUBE_MAP_NEGATIVE_Y		,	
	GP_RHI_TEXTURE_TARGET_CUBE_MAP_POSITIVE_Z 		,	
	GP_RHI_TEXTURE_TARGET_CUBE_MAP_NEGATIVE_Z 		,	
};

enum GP_RHI_PIXEL_STORE {
	GP_RHI_PIXEL_STORE_UNPACK_ALIGHMENT				,	
};

enum GP_RHI_HINT {
	GP_RHI_HINT_GENERATE_MIPMAP_HINT				,	
};

enum GP_RHI_HINT_MODE {
	GP_RHI_HINT_MODE_NICEST							,	
};

enum GP_RHI_SHADER_TYPE {
	GP_RHI_VERTEX_SHADER							,	
	GP_RHI_PIXEL_SHADER								,	
};

enum GP_RHI_SHADER_GET {
	GP_RHI_SHADER_GET_INFO_LOG_LENGTH				,	
	GP_RHI_SHADER_GET_COMPILE_STATUS 				,	
	GP_RHI_SHADER_GET_LINK_STATUS					,	
	GP_RHI_SHADER_GET_ACTIVE_ATTRIBUTES				,	
	GP_RHI_SHADER_GET_ACTIVE_ATTRIBUTE_MAX_LENGTH	,	
	GP_RHI_SHADER_GET_ACTIVE_UNIFORMS				,	
	GP_RHI_SHADER_GET_ACTIVE_UNIFORM_MAX_LENGTH		,	
};

enum GP_RHI_UNIFORM_TYPE {
	GP_RHI_UNIFORM_SAMPLER_2D						,	
	GP_RHI_UNIFORM_SAMPLER_CUBE 					,	
};

enum GP_RHI_TEXTURE_SLOT {
	GP_RHI_TEXTURE_SLOT_0							,	
	GP_RHI_TEXTURE_SLOT_1							,	
	GP_RHI_TEXTURE_SLOT_2							,	
	GP_RHI_TEXTURE_SLOT_3							,	
	GP_RHI_TEXTURE_SLOT_4							,	
	GP_RHI_TEXTURE_SLOT_5							,	
	GP_RHI_TEXTURE_SLOT_6							,	
	GP_RHI_TEXTURE_SLOT_7							,	
	GP_RHI_TEXTURE_SLOT_8							,	
	GP_RHI_TEXTURE_SLOT_9							,	
	GP_RHI_TEXTURE_SLOT_10							,	
	GP_RHI_TEXTURE_SLOT_11							,	
	GP_RHI_TEXTURE_SLOT_12							,	
	GP_RHI_TEXTURE_SLOT_13							,	
	GP_RHI_TEXTURE_SLOT_14							,	
	GP_RHI_TEXTURE_SLOT_15							,	
	GP_RHI_TEXTURE_SLOT_16							,	
	GP_RHI_TEXTURE_SLOT_17							,	
	GP_RHI_TEXTURE_SLOT_18							,	
	GP_RHI_TEXTURE_SLOT_19							,	
	GP_RHI_TEXTURE_SLOT_20							,	
	GP_RHI_TEXTURE_SLOT_21							,	
	GP_RHI_TEXTURE_SLOT_22							,	
	GP_RHI_TEXTURE_SLOT_23							,	
	GP_RHI_TEXTURE_SLOT_24							,	
	GP_RHI_TEXTURE_SLOT_25							,	
	GP_RHI_TEXTURE_SLOT_26							,	
	GP_RHI_TEXTURE_SLOT_27							,	
	GP_RHI_TEXTURE_SLOT_28							,	
	GP_RHI_TEXTURE_SLOT_29							,	
	GP_RHI_TEXTURE_SLOT_30							,	
	GP_RHI_TEXTURE_SLOT_31							,	
};
...
enum GP_RHI_BLEND_FUNC {
	GP_RHI_BLEND_ONE								,	
	GP_RHI_BLEND_ZERO								,	
	GP_RHI_BLEND_SRC_COLOR							,	
	GP_RHI_BLEND_ONE_MINUS_SRC_COLOR				,	
	GP_RHI_BLEND_DST_COLOR							,
	GP_RHI_BLEND_ONE_MINUS_DST_COLOR				,
	GP_RHI_BLEND_SRC_ALPHA							,	    
	GP_RHI_BLEND_ONE_MINUS_SRC_ALPHA				,	
	GP_RHI_BLEND_DST_ALPHA							,	
	GP_RHI_BLEND_ONE_MINUS_DST_ALPHA				,	
	GP_RHI_BLEND_CONSTANT_ALPHA						,
	GP_RHI_BLEND_ONE_MINUS_CONSTANT_ALPHA			,
	GP_RHI_BLEND_SRC_ALPHA_SATURATE					,
};

enum GP_RHI_CULL_FACE {
	GP_RHI_CULL_FACE_BACK							,	
	GP_RHI_CULL_FACE_FRONT							,	
	GP_RHI_CULL_FACE_FRONT_AND_BACK					,
};

enum GP_RHI_FRONT_FACE {
	GP_RHI_FRONT_FACE_CCW							,		
	GP_RHI_FRONT_FACE_CW							,		
};

enum GP_RHI_COMPARE_FUNC {
	GP_RHI_COMPARE_FUNC_NEVER						,	
	GP_RHI_COMPARE_FUNC_LESS 						,	
	GP_RHI_COMPARE_FUNC_EQUAL 						,	
	GP_RHI_COMPARE_FUNC_LEQUAL 						,	   
	GP_RHI_COMPARE_FUNC_GREATER 					,	   
	GP_RHI_COMPARE_FUNC_NOTEQUAL 					,	   
	GP_RHI_COMPARE_FUNC_GEQUAL 						,	   
	GP_RHI_COMPARE_FUNC_ALWAYS 						,	   
};

enum GP_RHI_STENCILOP {
	GP_RHI_STENCILOP_KEEP							,
	GP_RHI_STENCILOP_ZERO							,
	GP_RHI_STENCILOP_REPLACE						,
	GP_RHI_STENCILOP_INCR							,
	GP_RHI_STENCILOP_DECR							,
	GP_RHI_STENCILOP_INVERT							,
	GP_RHI_STENCILOP_INCR_WRAP						,
	GP_RHI_STENCILOP_DECR_WRAP						,
};

enum GP_RHI_GET {
	GP_RHI_GET_MAX_VERTEX_ATTRIBS					,
	GP_RHI_GET_FRAMEBUFFER_BINDING					,
	GP_RHI_MAX_COLOR_ATTACHMENTS					,
};
#endif
