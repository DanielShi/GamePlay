...
public:
    ...
    */
    ...
    enum Blend
    {
        BLEND_ZERO							= GP_RHI_BLEND_ZERO,
        BLEND_ONE							= GP_RHI_BLEND_ONE,
        BLEND_SRC_COLOR						= GP_RHI_BLEND_SRC_COLOR,
        BLEND_ONE_MINUS_SRC_COLOR			= GP_RHI_BLEND_ONE_MINUS_SRC_COLOR,
        BLEND_DST_COLOR						= GP_RHI_BLEND_DST_COLOR,
        BLEND_ONE_MINUS_DST_COLOR			= GP_RHI_BLEND_ONE_MINUS_DST_COLOR,
        BLEND_SRC_ALPHA						= GP_RHI_BLEND_SRC_ALPHA,
        BLEND_ONE_MINUS_SRC_ALPHA			= GP_RHI_BLEND_ONE_MINUS_SRC_ALPHA,
        BLEND_DST_ALPHA						= GP_RHI_BLEND_DST_ALPHA,
        BLEND_ONE_MINUS_DST_ALPHA			= GP_RHI_BLEND_ONE_MINUS_DST_ALPHA,
        BLEND_CONSTANT_ALPHA				= GP_RHI_BLEND_CONSTANT_ALPHA,
        BLEND_ONE_MINUS_CONSTANT_ALPHA		= GP_RHI_BLEND_ONE_MINUS_CONSTANT_ALPHA,
        BLEND_SRC_ALPHA_SATURATE			= GP_RHI_BLEND_SRC_ALPHA_SATURATE
    };
    ...
    enum DepthFunction
    {
        DEPTH_NEVER							= GP_RHI_COMPARE_FUNC_NEVER,
        DEPTH_LESS							= GP_RHI_COMPARE_FUNC_LESS,
        DEPTH_EQUAL							= GP_RHI_COMPARE_FUNC_EQUAL,
        DEPTH_LEQUAL						= GP_RHI_COMPARE_FUNC_LEQUAL,
        DEPTH_GREATER						= GP_RHI_COMPARE_FUNC_GREATER,
        DEPTH_NOTEQUAL						= GP_RHI_COMPARE_FUNC_NOTEQUAL,
        DEPTH_GEQUAL						= GP_RHI_COMPARE_FUNC_GEQUAL,
        DEPTH_ALWAYS						= GP_RHI_COMPARE_FUNC_ALWAYS
    };
    ...
    enum CullFaceSide
    {
        CULL_FACE_SIDE_BACK					= GP_RHI_CULL_FACE_BACK,
        CULL_FACE_SIDE_FRONT				= GP_RHI_CULL_FACE_FRONT,
        CULL_FACE_SIDE_FRONT_AND_BACK		= GP_RHI_CULL_FACE_FRONT_AND_BACK
    };
    ...
    enum FrontFace
    {
        FRONT_FACE_CW						= GP_RHI_FRONT_FACE_CW,
        FRONT_FACE_CCW						= GP_RHI_FRONT_FACE_CCW
    };
    ...
    {
		STENCIL_NEVER						= GP_RHI_COMPARE_FUNC_NEVER,
		STENCIL_ALWAYS						= GP_RHI_COMPARE_FUNC_ALWAYS,
		STENCIL_LESS						= GP_RHI_COMPARE_FUNC_LESS,
		STENCIL_LEQUAL						= GP_RHI_COMPARE_FUNC_LEQUAL,
		STENCIL_EQUAL						= GP_RHI_COMPARE_FUNC_EQUAL,
		STENCIL_GREATER						= GP_RHI_COMPARE_FUNC_GREATER,
		STENCIL_GEQUAL						= GP_RHI_COMPARE_FUNC_GEQUAL,
		STENCIL_NOTEQUAL					= GP_RHI_COMPARE_FUNC_NOTEQUAL
    };
    ...
    {
		STENCIL_OP_KEEP						= GP_RHI_STENCILOP_KEEP,
		STENCIL_OP_ZERO						= GP_RHI_STENCILOP_ZERO,
		STENCIL_OP_REPLACE					= GP_RHI_STENCILOP_REPLACE,
		STENCIL_OP_INCR						= GP_RHI_STENCILOP_INCR,
		STENCIL_OP_DECR						= GP_RHI_STENCILOP_DECR,
		STENCIL_OP_INVERT					= GP_RHI_STENCILOP_INVERT,
		STENCIL_OP_INCR_WRAP				= GP_RHI_STENCILOP_INCR_WRAP,
		STENCIL_OP_DECR_WRAP				= GP_RHI_STENCILOP_DECR_WRAP
    };
